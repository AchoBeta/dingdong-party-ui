     ...
     <div>
      ...
      <el-dialog
        ...
        <el-form
            ...
            label-width="120px">
          <el-form-item>
            <el-button v-if="authority == 3" style="margin-left: 85%;" type="primary" size="mini" @click="ruleForm.userId=formInfo.lastInfo.userId;registerDialog=true">设为管理员</el-button>
              ...
              <el-row>
                ...
                <el-col :span="11">
                  <el-form-item label="学号">
                    <el-input v-model="formInfo.studentId" placeholder="未填" disabled></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              ...
              <el-row>
                <el-col :span="11">
                  <el-form-item label="性别">
                    <el-input v-model="formInfo.gender2" placeholder="未填" disabled></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              ...
              <el-row>
                <el-col :span="11">
                  <el-form-item label="身份证号">
                    <el-input style="width: 98%" v-model="formInfo.idCard" placeholder="未填" disabled></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="11">
                  <el-form-item label="出生日期">
                    <el-date-picker type="date" placeholder="未填" v-model="formInfo.birthday" disabled></el-date-picker>
                  </el-form-item>
                </el-col>
              </el-row>
              ...
              <el-row>
                <el-col :span="11">
                  <el-form-item label="联系方式">
                    <el-input style="width: 98%" v-model="formInfo.phone" placeholder="未填" disabled></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="11">
                  <el-form-item label="家庭住址">
                    <el-input v-model="formInfo.familyAddress" placeholder="未填" disabled></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              ...
              <el-row>
                <el-col :span="11">
                  <el-form-item label="所在班级">
                    <el-input v-model="formInfo.className" placeholder="未填" disabled></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              ...
              <el-row>
                <el-col :span="11">
                  <el-form-item label="所在社区">
                    <el-input style="width: 98%" v-model="formInfo.dormitoryArea" placeholder="未填" disabled></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="11">
                  <el-form-item label="宿舍号">
                    <el-input v-model="formInfo.dormitoryNo" placeholder="未填" disabled></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              ...
              <el-row>
                <el-col :span="11">
                  <el-form-item label="职务">
                    <el-input style="width: 98%" v-model="formInfo.classPosition" placeholder="未填" disabled></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="11">
                  <el-form-item label="入党时间">
                    <el-input style="width: 98%" v-model="formInfo.joinLeagueTime" placeholder="未填" disabled></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
            </el-card>
          ...
          <el-form-item v-if="formInfo.lastInfo.status==0" label="信息审核" style="text-align: center;height: auto">
            <el-card style="text-align: center">
              <el-button v-if="!this.show" type="primary" @click="passInfo('通过',formInfo.lastInfo.groupId,formInfo.lastInfo.userId)" style="margin-left: 10px">通过</el-button>
              <el-button v-if="!this.show" type="primary" @click="changeShow" style="margin-left: 10px">驳回</el-button>
              ...
              <div style="margin-bottom:50px" v-if="this.show">
                ...
                <el-button type="primary" @click="rejectInfo('不通过',formInfo.lastInfo.groupId,formInfo.lastInfo.userId)" style="margin-left: 10px">提交</el-button>
              </div>
            </el-card>
          </el-form-item>
        </el-form>
...
export default {
  ...
  data(){
    ...
    return{
      ...
      //权限选择数组
      ,authorityOption:[{id:'1',name: '创建'},{id:'2',name: '创建+审核'},{id: '3',name: '创建+审核+创建管理员'}]
    }
  },
  methods:{
    // 改变页码
    ...
    SearchAllMsg(row){
      //用户基本信息
      userRequest({
        url:'/dingdong-party/base/users/'+row.userId+'/info',//拼接url
      }).then(res => {
      ...
      //活动信息
      userRequest({
        url: '/dingdong-party/base/users/'+row.userId+'/acitvities'
      }).then(res =>{
    ...
    //信息审核
    passInfo(status,groupId,userId){//通过
      console.log(status+groupId+userId)
      userRequest({
        url: '/dingdong-party/backstage/admins/examine-user-info',
        params:{
          status: status,
          groupId: groupId,
          userId: userId,
    ...
    rejectInfo(status,groupId,userId){//驳回
  ...
  //加载选项信息
    ...
    ,loadInstitute() {
      this.listMajor = []
      userRequest({
        url: '/dingdong-party/backstage/institutes',
      }).then(res => {
        console.log(res)
    ...
    ,loadMajor(instituteId,instituteName) {
      ...
      userRequest({
        url: '/dingdong-party/backstage/institutes/'+instituteId+'/major',
      }).then(res => {
        console.log(res)
    ...
    ,loadGrade() {
      userRequest({
        url: '/dingdong-party/base/others/max-grade',
      }).then(res => {
        console.log(res)
