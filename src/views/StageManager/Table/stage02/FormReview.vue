    ...
    <el-table :data="tableData" style="width: 100%" v-loading="loading">
      ...
      <el-table-column label="当前状态">
        <template slot-scope="scope">
          <el-tag type="danger" v-if="scope.row.pivot.status == -1">审核不通过</el-tag>
          <el-tag v-else-if="scope.row.pivot.status == 0">待审核</el-tag>
          <el-tag type="success" v-else-if="scope.row.pivot.status == 1">已审核通过</el-tag>
        </template>
      </el-table-column>
                ...
                <el-row>
                  <el-col :span="11">
                    <el-form-item label="性别">
                      <el-input style="width: 98%" :value="formInfo.gender=='1'?'男':'女'" placeholder="未填" disabled></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="11">
                    <el-form-item label="确定为入党积极分子时间">
                      <el-date-picker type="date" placeholder="未填" v-model="formInfo.userBranch.activist_time" disabled></el-date-picker>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  ...
                  <el-col :span="11">
                    <el-form-item label="申请入党时间">
                      <el-date-picker type="date" placeholder="未填" v-model="formInfo.userBranch.apply_time" disabled></el-date-picker>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-form-item label="培养联系人1">
                  <el-card shadow="always">
                    ...
                    <el-row v-if="formInfo.userBranch.firstContact">
                      <el-col :span="11">
                        <el-form-item label="姓名">
                          <el-input style="width: 98%" :value="formInfo.userBranch.firstContact.name" placeholder="未填" disabled></el-input>
                        </el-form-item>
                      </el-col>
                      <el-col :span="11">
                        <el-form-item label="党内职务">
                          <el-input :value="formInfo.userBranch.firstContact.party_positions" placeholder="未填" disabled></el-input>
                        </el-form-item>
                      </el-col>
                    </el-row>
                    <el-row v-if="formInfo.userBranch.firstContact">
                      <el-col :span="11">
                        <el-form-item label="党龄">
                          <el-input style="width: 98%" :value="formInfo.userBranch.firstContact.party_age" placeholder="未填" disabled></el-input>
                        </el-form-item>
                      </el-col>
                      <el-col :span="11">
                        <el-form-item label="行政职务">
                          <el-input :value="formInfo.userBranch.firstContact.administrative_position" placeholder="未填" disabled></el-input>
                        </el-form-item>
                      </el-col>
                    </el-row>
                  </el-card>
                ...
                <el-form-item label="培养联系人2">
                  <el-card shadow="always">
                    ...
                    <el-row v-if="formInfo.userBranch.secondContact">
                      <el-col :span="11">
                        <el-form-item label="姓名">
                          <el-input style="width: 98%" :value="formInfo.userBranch.secondContact.name" placeholder="未填" disabled></el-input>
                        </el-form-item>
                      </el-col>
                      <el-col :span="11">
                        <el-form-item label="党内职务">
                          <el-input :value="formInfo.userBranch.secondContact.party_positions" placeholder="未填" disabled></el-input>
                        </el-form-item>
                      </el-col>
                    </el-row>
                    <el-row v-if="formInfo.userBranch.secondContact">
                      <el-col :span="11">
                        <el-form-item label="党龄">
                          <el-input style="width: 98%" :value="formInfo.userBranch.secondContact.party_age" placeholder="未填" disabled></el-input>
                        </el-form-item>
                      </el-col>
                      <el-col :span="11">
                        <el-form-item label="行政职务">
                          <el-input :value="formInfo.userBranch.secondContact.administrative_position" placeholder="未填" disabled></el-input>
                        </el-form-item>
                      </el-col>
                    </el-row>
                  </el-card>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="奖励情况">
                      <el-input type="textarea" v-model="formInfo.userBranch.awards_info" placeholder="无" disabled autosize></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="受处分情况">
                      <el-input type="textarea" v-model="formInfo.userBranch.disposition_info" placeholder="无" disabled autosize></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="2次考察情况(半年一次)">
                      <el-input type="textarea" placeholder="无" disabled v-if="!formInfo.userBranch.investigation_in_half_year_activist"></el-input>
                      <div v-for="(item,index) in formInfo.userBranch.investigation_in_half_year_activist" :key="index" style="margin-bottom: 5px">
                        <el-input type="textarea" :value="item" placeholder="无" disabled></el-input>
                      </div>
                    </el-form-item>
                  </el-col>
                </el-row>
