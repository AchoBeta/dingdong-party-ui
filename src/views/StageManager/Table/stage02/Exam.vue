<template>
  <div>
    <el-table :data="tableData" style="width: 100%" v-loading="loading">
      ...
      <el-table-column label="成绩" prop="score.branch_school_score"></el-table-column>
            ...
            <el-dialog title="成绩录入" 
              ...
              <el-form 
                ...
                <el-form-item label="成绩：">
                  <el-input v-model="gradeForm.branch_school_score" autocomplete="off"></el-input>
                </el-form-item>
...
import {request} from '../../../../network/request'
  export default {
    ...
    ,methods: {
      ...
      gradeSubmit(){
        //判断成绩合法
        if(this.gradeForm.branch_school_score > 100 || this.gradeForm.branch_school_score < 0 || this.gradeForm.branch_school_score == ""){
          this.$message({
