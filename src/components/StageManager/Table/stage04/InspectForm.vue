                ...
                <el-row>
                  <el-col :span="11">
                    <el-form-item label="姓名">
                      <el-input style="width: 98%" v-model="formInfo.name" placeholder="姓名" disabled></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="11">
                    <el-form-item label="联系方式">
                      <el-input v-model="formInfo.mobile" placeholder="联系方式" disabled></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  <el-col :span="11">
                    <el-form-item label="所在单位">
                      <el-input style="width: 98%" v-model="formInfo.institute" placeholder="所在单位" disabled></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="11">
                    <el-form-item label="所在党支部">
                      <el-input v-model="formInfo.branch.name" placeholder="所在党支部" disabled></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  <el-col :span="11">
                    <el-form-item label="性别">
                      <el-input style="width: 98%" :value="formInfo.gender=='1'?'男':'女'" placeholder="性别" disabled></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="11">
                    <el-form-item label="出生日期">
                      <el-date-picker type="date" placeholder="选择日期" v-model="formInfo.birth" disabled></el-date-picker>
                    </el-form-item>
                  </el-col>
                ...
                <el-row>
                  <el-col :span="11">
                    <el-form-item label="确定为发展对象时间">
                      <el-date-picker type="date" placeholder="未填" v-model="formInfo.userBranch.confirm_development_time" disabled></el-date-picker>
                    </el-form-item>
                  </el-col>
                  <el-col :span="11">
                    <el-form-item label="接收为预备党员时间">
                      <el-date-picker type="date" placeholder="未填" v-model="formInfo.userBranch.probationary_time" disabled></el-date-picker>
                    </el-form-item>
                  </el-col>
                </el-row>

                <el-col :span="24">
                  <el-form-item label="党支部半年考察意见">
