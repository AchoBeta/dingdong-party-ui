              ...
              <el-form 
                ...
                <el-col :span="24">
                  <el-form-item label="培养联系人意见">
                    <el-input type="textarea" v-model="formInfo.userBranch.opinions_for_supply_prepare.introduce_opinion_for_prepare" placeholder="无" disabled autosize></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="24">
                  <el-form-item label="党小组意见">
                    <el-input type="textarea" v-model="formInfo.userBranch.opinions_for_supply_prepare.group_opinion_for_prepare" placeholder="无" disabled autosize></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="24">
                  <el-form-item label="征求群众意见">
                    <el-input type="textarea" v-model="formInfo.userBranch.opinions_for_supply_prepare.masses_opinion_for_prepare" placeholder="无" disabled autosize></el-input>
                  </el-form-item>
                </el-col>
