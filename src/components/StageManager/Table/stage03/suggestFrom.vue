              ...
              <el-form 
                ...
                <el-col :span="24">
                  <el-form-item label="培养联系人意见">
                    <el-input type="textarea" v-model="formInfo.userBranch.opinions_for_supply_activist.introduce_opinion_for_activist" placeholder="无" disabled autosize></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="24">
                  <el-form-item label="党小组意见">
                    <el-input type="textarea" v-model="formInfo.userBranch.opinions_for_supply_activist.group_opinion_for_activist" placeholder="无" disabled autosize></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="24">
                  <el-form-item label="征求群众意见">
                    <el-input type="textarea" v-model="formInfo.userBranch.opinions_for_supply_activist.masses_opinion_for_activist" placeholder="无" disabled autosize></el-input>
                  </el-form-item>
                </el-col>

                <el-form-item label="参加学校党校培训情况">
                  <el-card shadow="always">
                    <span v-if="!formInfo.userBranch.opinions_for_supply_activist.group_opinion_for_activist">无</span>
                    <el-row v-if="formInfo.userBranch.opinions_for_supply_activist.group_opinion_for_activist">
                      <el-col :span="11">
                        <el-form-item label="培训时间">
                          <el-date-picker type="date" placeholder="未填" :value="formInfo.userBranch.opinions_for_supply_activist.train_time" disabled></el-date-picker>
                        </el-form-item>
                      </el-col>
                      <el-col :span="11">
                        <el-form-item label="主讲人">
                          <el-input style="width: 98%" :value="formInfo.userBranch.opinions_for_supply_activist.speaker" placeholder="未填" disabled></el-input>
                        </el-form-item>
                      </el-col>
                    </el-row>
                      <el-col :span="24">
                        <el-form-item label="主要内容">
                          <el-input type="textarea" v-model="formInfo.userBranch.opinions_for_supply_activist.main_conent" placeholder="无" disabled autosize></el-input>
                        </el-form-item>
                      </el-col>
                    <el-row>
