          ...
          <el-form-item label="阶段">
            <el-select placeholder="选择阶段" v-model="selectedStage">
              <el-option
                ...
                :label="item.name"
                :value="item.id"
                @click.native="changSelectedStageIndex(item.index)"
              ></el-option>
            </el-select>
          </el-form-item>
      ...
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column label="操作" fixed="right">
          <template slot-scope="scope">
            <el-button type="primary" size="mini" @click="getAllInfo(scope.row)"
              >查看</el-button
            >
          </template>
        </el-table-column>
              ...
              <el-row>
                ...
                <el-col :span="11">
                  <el-form-item label="家庭住址">
                    <el-input
                      v-model="formInfo.family_address"
                      placeholder="未填"
                      disabled
                    ></el-input>
                  </el-form-item>
              ...
              <el-row>
                <el-col :span="11">
                  <el-form-item label="所在社区">
                    <el-input
                      style="width: 98%"
                      v-model="formInfo.dormitory_area"
                      placeholder="未填"
                      disabled
                    ></el-input>
                  </el-form-item>
              ...
              <el-row>
                <el-col :span="11">
                  <el-form-item label="职务">
                    <el-input
                      style="width: 98%"
                      v-model="formInfo.class_position"
                      placeholder="未填"
                      disabled
                    ></el-input>
                  </el-form-item>
